      ...
      <div className="mubl-ct-grid">
        ...
        <div className="mubl-ct-content">
          <AnimatePresence mode="wait">
            ...
            >
              <h3
                className="mubl-ct-name"
                style={{ color: colorName, fontSize: fontSizeName }}
              >
                {activeTestimonial.name}
              </h3>
              <p
                className="mubl-ct-designation"
                style={{ color: colorDesignation, fontSize: fontSizeDesignation }}
              >
                {activeTestimonial.designation}
              </p>
              <motion.p
                className="mubl-ct-quote"
          ...
          <div className="mubl-ct-arrows">
            <button
              className="mubl-ct-arrow-button"
              onClick={handlePrev}
              style={{
