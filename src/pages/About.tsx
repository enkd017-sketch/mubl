import { Target, Lightbulb, Users, GraduationCap, Heart, Zap, Globe } from "lucide-react";
...
const timeline = [
  { 
    year: "2023", 
    title: "Club Founded", 
    description: "MUBL was established at New Uzbekistan University with a vision to bridge theory and practice in engineering education." 
  },
  { 
    year: "2024", 
    title: "First Competition Success", 
    description: "Participated in UzCanSat competition and achieved 3rd place, marking our first milestone in aerospace." 
  },
  { 
    year: "2024", 
    title: "SpaceFest Launch", 
    description: "Successfully organized the first SpaceFest event, bringing together space enthusiasts from across Uzbekistan." 
  },
  { 
    year: "2025", 
    title: "UzCanSat Champions", 
    description: "Won 1st place at UzCanSat 2025, demonstrating our growth in satellite technology." 
  },
  { 
    year: "2025", 
    title: "International Stage", 
    description: "Competed at Teknofest in Turkey and presented at Young Leaders Symposium in Abu Dhabi." 
  },
];
        ...
        <div className="px-6 py-12">
          ...
          <div className="max-w-4xl mb-20">
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              real competitions, and real mentorship from industry experts. Our goal is to transform 
              passionate students into capable engineers who can solve the world's most pressing challenges.
            </p>
          </div>
